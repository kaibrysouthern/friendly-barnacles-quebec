...
//run().catch(console.dir); kaibrys-papa-database
...
async function cxnDB(){
  ...
  try{
    await client.connect().then(
      client.db("kaibrys-papa-database").collection("dev-profiles")
      );       
  }
  catch(e){
      console.log(e)
...
app.get('/', async (req, res) => {
 ...
 client.connect;
  let mongoResult = await client.db("kaibrys-papa-database").collection("dev-profiles").find().toArray();
...
app.get('/kaibry', function (req, res) {
  res.render('index', 
  {
